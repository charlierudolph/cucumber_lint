Feature: linting
  ...
  Scenario: a feature with unformatted table headers (lowercase)
    ...
    Then I see the output
      ...
      ./features/test.feature:5: lowercase table headers
      ./features/test.feature:13: lowercase "<VEGETABLE>"
      ./features/test.feature:13: lowercase "<FRUIT>"
      ./features/test.feature:14: lowercase "<CODE NAME>"
      ./features/test.feature:17: lowercase table headers
